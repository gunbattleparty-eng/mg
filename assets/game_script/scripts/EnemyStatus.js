...
var l = (function () {
    ...
    t.prototype.addDebuff = function (t) {
        ...
        if (t.type !== o.BACK || !this.hasDebuff(o.ADSORB)) {
            ...
            if (t.type === o.BURN) {
                ...
                this.debuffTypeMap.has(o.BURN) ||
                    (this.proxyEnemy.startDebuffAnim(t.type), this.debuffTypeMap.set(o.BURN, 0));
                ...
                if (t.type === o.BACK) {
                    ...
                    if (t.type === o.FREEZE) {
                        t.timeLeft += e;
                        this.debuffTypeMap.has(o.FREEZE)
                            ? (s = this.debuffInfos.find(function (t) {
                                  return t.type === o.FREEZE;
                              }))
                                ? (s.timeLeft = t.timeLeft)
                                : this.debuffInfos.push(t)
                            : (this.debuffTypeMap.set(o.FREEZE, 1),
                              this.debuffInfos.push(t),
                              this.proxyEnemy.startDebuffAnim(t.type),
                              this.proxyEnemy.startDebuffAnim(o.STOP_ANIM));
                        this.tryRecoverSpeed();
                    } else {
                        if (t.type === o.PARALYSIS) {
                            t.timeLeft += e;
                            this.debuffTypeMap.has(o.PARALYSIS)
                                ? (s = this.debuffInfos.find(function (t) {
                                      return t.type === o.PARALYSIS;
                                  }))
                                    ? (s.timeLeft = t.timeLeft)
                                    : this.debuffInfos.push(t)
                                : (this.debuffTypeMap.set(o.PARALYSIS, 1),
                                  this.debuffInfos.push(t),
                                  this.proxyEnemy.startDebuffAnim(t.type),
                                  this.proxyEnemy.startDebuffAnim(o.STOP_ANIM));
                            this.tryRecoverSpeed();
                            ...
                            if (t.type === o.RECOVER) {
                                this.debuffTypeMap.has(o.RECOVER)
                                    ? (s = this.debuffInfos.find(function (t) {
                                          return t.type === o.RECOVER;
                                      }))
                                        ? (s.timeLeft = t.timeLeft)
                                        : this.debuffInfos.push(t)
                                    : (this.debuffTypeMap.set(o.RECOVER, 1),
                                      this.debuffInfos.push(t),
                                      this.proxyEnemy.startDebuffAnim(t.type),
                                      -1 == t.value && this.proxyEnemy.startDebuffAnim(o.STOP_ANIM));
                                ...
                                if (t.type === o.SLOW) {
                                    ...
                                    if (t.type === o.STUN) {
                                        var s;
                                        t.timeLeft += e;
                                        this.debuffTypeMap.has(o.STUN)
                                            ? (s = this.debuffInfos.find(function (t) {
                                                  return t.type === o.STUN;
                                              }))
                                                ? (s.timeLeft = t.timeLeft)
                                                : this.debuffInfos.push(t)
                                            : (this.debuffTypeMap.set(o.STUN, 1),
                                              this.debuffInfos.push(t),
                                              this.proxyEnemy.startDebuffAnim(t.type),
                                              this.proxyEnemy.startDebuffAnim(o.STOP_ANIM));
                                        this.tryRecoverSpeed();
                                        ...
                                        if (t.type === o.ALL_ATK_ADD) {
                                            if (this.debuffTypeMap.has(o.ALL_ATK_ADD)) {
                                                ...
                                                this.debuffTypeMap.set(
                                                    o.ALL_ATK_ADD,
                                                    this.debuffTypeMap.get(o.ALL_ATK_ADD) + 1
                                                );
                                                this.debuffInfos.push(t);
                                            } else {
                                                this.debuffInfos.push(t);
                                            ...
                                            t.type === o.ADSORB
                                                ? (this.debuffTypeMap.has(o.ADSORB) ||
                                                      this.debuffTypeMap.set(o.ADSORB, 1),
                                                  this.tryRecoverSpeed())
                                                : t.type === o.FORBID_RECOVER &&
                                                  this.debuffTypeMap.set(o.FORBID_RECOVER, 1);
                                        }
                                    }
                                }
                            }
                ...
                if (t === o.FORBID_RECOVER) {
                    ...
                    if (t === o.SLOW) {
                        void 0 !== e
                            ? (i = this.debuffInfos.findIndex(function (t) {
                                  return t.type === o.SLOW;
                              })) > -1 && (this.debuffInfos.splice(i, 1), this.deleteDebuffType(t))
                            : this.deleteDebuffType(t);
                    } else {
                        if (t === o.RECOVER) {
                            var i;
    ...
    t.prototype.tryRecoverSpeed = function () {
        if (this.debuffTypeMap.has(o.ADSORB)) {
        } else {
            if (this.debuffTypeMap.has(o.BACK)) {
                ...
                this.debuffTypeMap.has(o.PARALYSIS) ||
                this.debuffTypeMap.has(o.RECOVER)
                    ? ((this.isStoping = !0), (this.proxyEnemy.speed = 0))
                    : this.debuffTypeMap.has(o.SLOW)
                    ? ((this.proxyEnemy.velocity.x = 0),
                      (this.proxyEnemy.velocity.y = -1),
                      (this.proxyEnemy.speed = this.initSpeed * (1 + this.slowSpeedAdd)),
                      (this.isStoping = !1))
                    : ((this.proxyEnemy.velocity.x = 0),
                      (this.proxyEnemy.velocity.y = -1),
                      (this.proxyEnemy.speed = this.initSpeed),
                      (this.isStoping = !1));
            }
        }
        if (!this.isStoping) {
        ...
        for (var n = 0; n < i; n++) {
            ...
            if (s.timeLeft > 0) {
            ...
            } else {
                {
                    ...
                    r <= 0
                        ? (this.debuffTypeMap.delete(s.type), this.deleteDebuffType(s.type))
                        : this.debuffTypeMap.set(s.type, r);
                }
            }
        }
        this.allDamage = e;
    ...
    t.prototype.deleteDebuffType = function (t) {
        t === o.STUN
            ? (this.debuffTypeMap.delete(o.STUN), this.proxyEnemy.endDebuffAnim(o.STUN), this.tryRecoverSpeed())
            : t === o.SLOW
            ? (this.debuffTypeMap.delete(o.SLOW), this.tryRecoverSpeed())
            : t === o.BURN
            ? (this.debuffTypeMap.delete(o.BURN), this.proxyEnemy.endDebuffAnim(o.BURN))
            : t === o.BACK
            ? ((this.backSpeed = 150), this.debuffTypeMap.delete(o.BACK), this.tryRecoverSpeed())
            : t === o.FREEZE
            ? (this.debuffTypeMap.delete(o.FREEZE), this.proxyEnemy.endDebuffAnim(o.FREEZE), this.tryRecoverSpeed())
            : t === o.PARALYSIS
            ? (this.debuffTypeMap.delete(o.PARALYSIS),
              this.proxyEnemy.endDebuffAnim(o.PARALYSIS),
              this.tryRecoverSpeed())
            : t === o.ALL_ATK_ADD
            ? this.debuffTypeMap.delete(o.ALL_ATK_ADD)
            : t === o.RECOVER
            ? (this.debuffTypeMap.delete(o.RECOVER), this.proxyEnemy.endDebuffAnim(o.RECOVER), this.tryRecoverSpeed())
            : t === o.ADSORB
            ? (this.debuffTypeMap.delete(o.ADSORB), this.tryRecoverSpeed())
            : t === o.FORBID_RECOVER && this.debuffTypeMap.delete(o.ADSORB);
    };
    t.prototype.updateF = function (t) {
        if (!this.isDie) {
            ...
            if (0 !== e && this.debuffintervalTimeLeft <= 0) {
                ...
                a && a.thermobaricEnemyBoomRange > 0
                    ? this.proxyEnemy.sufferAtk({
                          skillSpecialitys: [],
                          atk: e,
