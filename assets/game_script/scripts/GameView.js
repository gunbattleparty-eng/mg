...
var M =
    ...
    (function (t) {
        ...
        e.prototype.onLoad = function () {
            ...
            $gameContext.default.ins.init(
                this.enemyLayer,
                this.enemy2Layer,
                this.buttleLayer,
                this.floorLayer,
                this.enemyDebuffLayer
            );
            ...
            if (6 === $gameContext.default.ins.currLevelInfoConfig.id) {
                $assetsLoader.default.instance.loadRes(
                    ...
                    function (e, i) {
                        var o = i[0];
                        if (o && cc.isValid(o)) {
                            t.node.children[0].getComponent(cc.Sprite).spriteFrame = $resUtil.ResUtil.assignWith(
                                o,
                                t.node
                            );
                        }
        ...
        e.prototype.clickGuid = function () {
            ...
            0 === this.guideStep
                ? ((this.guideStep = 1), $guide.default.self.startGuideMask(t, 1))
                : ((this.guideStep = 2),
                ...
                this.scheduleOnce(function () {
                    ...
                    if (e.length > 0) {
                        ...
                        $popupManager.PopupManager.instance.open(
                            $assetsMap.AssetsMap.PopUpBundles.prefabs.assetsList.ChooseSkillView,
                            {
                                ids: e,
                                rootNode: t.node
                            },
        ...
        e.prototype.startCheckEnd = function (t) {
            ...
            t
                ? this.currIndex < $gameContext.default.ins.currLevelConfig.length - 1 ||
                  0 !== this.layerCount() ||
                  0 !== this.enemy2Layer.children.length ||
                  ((this.isCheckEnd = !0), (this.checkTime = $gameContext.default.ins.gameStartTime))
                : (this.isCheckEnd = !1);
        };
        e.prototype.clickGameRatio = function () {
            ...
            $globalParam.default.isGamePuase = !0;
            $popupManager.PopupManager.instance.open(
                $assetsMap.AssetsMap.PopUpBundles.prefabs.assetsList.GameSpeedView,
                null,
                {
                    closeCallback: function () {
                        $globalParam.default.isGamePuase = !1;
        ...
        e.prototype.createAtkAnim = function (t, e, i, o, n) {
            ...
            cc.tween(t)
                .to(0.15 / $gameContext.default.ins.gameRatio, {
                    scale: 1
                })
        ...
        e.prototype.update = function (t) {
            if (!$globalParam.default.isGamePuase) {
                this.runGameLoop(t);
                1.5 === $gameContext.default.ins.gameRatio
                    ? this.isRepeat
                        ? (this.isRepeat = !1)
                        : (this.runGameLoop(t), (this.isRepeat = !0))
                    : 2 === $gameContext.default.ins.gameRatio
                    ? this.runGameLoop(t)
                    : 4 === $gameContext.default.ins.gameRatio &&
                      (this.runGameLoop(t), this.runGameLoop(t), this.runGameLoop(t));
                this.bossTip();
            }
        };
        e.prototype.runGameLoop = function (t) {
            ...
            if (
                !this.isEnd &&
                this.isCheckEnd &&
                $gameContext.default.ins.gameStartTime - this.checkTime > 3 &&
                0 === this.layerCount() &&
                0 === this.enemy2Layer.children.length
            ) {
                this.isEnd = !0;
                ...
                $popupManager.PopupManager.instance.open(
                    $assetsMap.AssetsMap.PopUpBundles.prefabs.assetsList.SettleView,
                    {
                        isSuccess: !0
                    }
                );
        ...
        e.prototype.layerCount = function () {
            ...
            if (
                1 === t &&
                "EggEnemy_1" === this.enemyLayer.children[0].name &&
                this.enemyLayer.children[0].getComponent($eggEnemy_1.default).currType < 2
            ) {
                t = 0;
            }
            return t;
        ...
        e.prototype.bossTip = function () {
            for (var t = 0; t < $gameContext.default.ins.warnTimes.length; t++) {
                if (
                    ...
                    $gameContext.default.ins.gameStartTime >= $gameContext.default.ins.warnTimes[t]
                ) {
                    $gameContext.default.ins.warnIndex = t;
                    $popupManager.PopupManager.instance.open(
                        $assetsMap.AssetsMap.PopUpBundles.prefabs.assetsList.BossWarnView,
                        {
        ...
        e.prototype.createEnemy = function () {
            if (
                !(
                    this.enemyLayer.children.length + this.enemy2Layer.children.length >= 150 ||
                    this.currIndex >= $gameContext.default.ins.currLevelConfig.length
                )
            ) {
                ...
                if (!(t.time > this.currTime)) {
                    ...
                    this.currIndex++;
                    $gameContext.default.ins.createEnemyProccess =
                        this.currIndex / $gameContext.default.ins.currLevelConfig.length;
                }
            }
        };
        ...
        e.prototype.clickPause = function () {
            ...
            $remoteAudio.default.instance.pauseAllEffectMusic();
            $popupManager.PopupManager.instance.open(
                $assetsMap.AssetsMap.PopUpBundles.prefabs.assetsList.PauseView,
                null,
                {
                    closeCallback: function () {
                        $remoteAudio.default.instance.resumeAllEffectMusic();
        ...
        e.prototype.renderSpeedBtn = function () {
            1 === $gameContext.default.ins.gameRatio
                ? $util.default.updateMaterialState(this.btnGameRatio, !0)
                : ($util.default.updateMaterialState(this.btnGameRatio, !1),
                  (this.btnGameRatio.children[0].getComponent(cc.Label).string =
                      "X" + $gameContext.default.ins.gameRatio));
        };
