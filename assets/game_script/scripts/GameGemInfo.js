...
var a = (function () {
    ...
    t.prototype.setGemProp = function (t, e) {
        this.skillValue[t]
            ? (this.skillValue[t][this.skillValue[t].length - 1] = $util.default.amend(
                  this.skillValue[t][this.skillValue[t].length - 1],
                  e[this.skillValue[t].length - 1],
                  "+"
              ))
            : (this.skillValue[t] = $util.default.deepCopy(e));
    };
    ...
    t.ins = new t();
    t.gemColor = [
        new cc.Color().fromHEX("#d4ccbe"),
        new cc.Color().fromHEX("#74c93a"),
        new cc.Color().fromHEX("#54b7f0"),
        new cc.Color().fromHEX("#c778ff"),
        new cc.Color().fromHEX("#ff8b42"),
        new cc.Color().fromHEX("#ff5e6e"),
        new cc.Color().fromHEX("#fcdd4es")
    ];
    return t;
})();
