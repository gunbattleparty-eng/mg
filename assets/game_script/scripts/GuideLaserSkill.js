...
var a = (function (t) {
    ...
    e.prototype.chooseSkill = function (t) {
        116 === t.id
            ? ((this.skillAtk[$gameSkillInfo.Skill4Param.BASIC] = $skillContext.default.Ins.getSKillAtk(t)),
              ...
              (this.guideLaserTime = t.add_sx[1]),
              (this.guideLaserAtkInterval = t.add_sx[2]),
              (this.skillAtkRange[$gameSkillInfo.Skill4Param.BASIC] = t.add_sx[4]),
              (this.guideLaserRefractRange = t.add_sx[6]),
              (this.guideLaserSpeed = t.add_sx[0]),
              (this.guideLaserMaserAtk[$gameSkillInfo.Skill4Param.BASIC] =
                  this.skillAtk[$gameSkillInfo.Skill4Param.BASIC]),
              this.caculateFinal(this.skillAtk),
              this.caculateFinal(this.skillCD, !1),
              this.caculateFinal(this.skillAtkRange),
              this.caculateFinal(this.guideLaserMaserAtk))
            : 117 === t.id
            ? (this.updateAndCalculate(this.skillAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD),
              this.updateAndCalculate(this.guideLaserMaserAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD))
            : 118 === t.id
            ? this.updateAndCalculate(this.guideLaserMaserAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD)
            : 119 === t.id
            ? ((this.guideLaserBoomAtk[$gameSkillInfo.Skill4Param.BASIC] = this.getBasicAtk(t.add_sx[0])),
              this.caculateFinal(this.guideLaserBoomAtk),
              (this.guideLaserBoomRange += t.add_sx[1]))
            : 120 === t.id
            ? this.updateAndCalculate(this.guideLaserMaserAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD)
            : 121 === t.id
            ? (this.guideLaserRefractCount += t.add_sx[0])
            : 122 === t.id || 134 === t.id
            ? (this.guideLaserTime += Math.ceil(t.add_sx[0] * this.guideLaserAtkInterval))
            : 123 === t.id
            ? this.updateAndCalculate(this.skillAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD)
            : 124 === t.id
            ? ((this.guideLaserThunderAtk[$gameSkillInfo.Skill4Param.BASIC] = this.getBasicAtk(t.add_sx[0])),
              (this.guideLaserIsThunder = !0))
            : 125 === t.id
            ? (this.updateAndCalculate(this.skillCD, t.add_sx[0], $gameSkillInfo.Skill4Param.DEC, !1),
              (this.guideLaserWidth += t.add_sx[1]))
            : 126 === t.id
            ? (this.guideLaserContinueAtk += t.add_sx[0])
            : 130 === t.id
            ? ((this.skillAtkRange[$gameSkillInfo.Skill4Param.BASIC] += t.add_sx[0]),
              this.caculateFinal(this.skillAtkRange))
            : 132 === t.id
            ? (this.updateAndCalculate(this.guideLaserBurnAtk, t.add_sx[1], $gameSkillInfo.Skill4Param.ADD),
              (this.guideLaserBurnTime += t.add_sx[1]))
            : 133 === t.id && (this.guideLaserBack += t.add_sx[0]);
    };
    ...
    e.prototype.toString = function () {
        return (
            ...
            "\n        制导激光速:" +
            this.guideLaserSpeed +
            "\n        制导激光持续时间: " +
            this.guideLaserTime +
            "\n        制导激光攻击间隔: " +
            this.guideLaserAtkInterval +
            "\n        制导激光折射范围: " +
            this.guideLaserRefractRange +
            "\n        制导激光折射次数: " +
            this.guideLaserRefractCount +
            "\n        制导激光主目标伤害: " +
            this.guideLaserMaserAtk +
            "\n        制导激光爆炸伤害: " +
            this.guideLaserBoomAtk +
            "\n        制导激光爆炸范围: " +
            this.guideLaserBoomRange +
            "\n        制导激光是否触发磁暴闪电: " +
            this.guideLaserIsThunder +
            "\n        制导激光触发磁暴闪电伤害: " +
            this.guideLaserThunderAtk +
            "\n        制导激光宽度: " +
            this.guideLaserWidth +
            "\n        制导激光燃烧伤害: " +
            this.guideLaserBurnAtk +
            "\n        制导激光燃烧时间: " +
            this.guideLaserBurnTime +
            "\n        制导激光开始后续伤害叠加: " +
            this.guideLaserContinueAtk +
            "\n        制导激光击退敌人像素: " +
            this.guideLaserBack +
            "\n        "
        );
