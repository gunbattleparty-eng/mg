...
var A = (function (t) {
    ...
    e.prototype.refreshBtn = function () {
        ...
        this.config.id < e || ($weekCardService.default.Ins.isSign() && this.config.id === e)
            ? ((this.btnGain.getComponentInChildren(cc.Label).string = "已领取"),
            ...
            : this.config.id > e &&
              ((this.btnGain.getComponentInChildren(cc.Label).string = "暂不可领"),
              $util.default.updateMaterialState(this.btnGain, !0),
              (this.btnGain.getComponent(cc.Button).interactable = !1));
                                    ...
                                    if (7 === o) {
                                        ...
                                        if (8 === o) {
                                            ...
                                            if (9 === o) {
                                                ...
                                                if (10 === o) {
                                                    var S = $configContext.default.instance.gemConfigs.filter(function (
                                                        e
                                                    ) {
