    ...
    e.prototype.chooseSkill = function (t) {
        100 === t.id
            ? ((this.skillAtk[$gameSkillInfo.Skill4Param.BASIC] = $skillContext.default.Ins.getSKillAtk(t)),
              (this.pulseLaserWidthAdd += t.add_sx[0]),
              (this.pulseLaserTime = $skillContext.default.Ins.getSkillTime(t)),
              (this.pulseLaserAtkInterval[$gameSkillInfo.Skill4Param.BASIC] =
                  $skillContext.default.Ins.getAtkInterval(t)),
              ...
              this.caculateFinal(this.pulseLaserAtkInterval),
            ...
            : 102 === t.id
            ? ((this.pulseLaserSlowTime += t.add_sx[0]), (this.pulseLaserSlowAdd += t.add_sx[1]))
            : 103 === t.id
            ? (this.updateAndCalculate(this.skillCD, t.add_sx[0], $gameSkillInfo.Skill4Param.ADD, !1),
              this.updateAndCalculate(this.pulseLaserAtkInterval, t.add_sx[1], $gameSkillInfo.Skill4Param.DEC, !1))
            : 104 === t.id
            ? ((this.pulseLaserCount += 1),
            ...
            ? ((this.pulseLaserSweepCount = 1),
              this.updateAndCalculate(this.skillAtk, t.add_sx[0], $gameSkillInfo.Skill4Param.DEC))
            : 107 === t.id
            ? (this.pulseLaserTime += t.add_sx[0])
            : 108 === t.id
            ? this.pulseLaserEnemyAtkAddParam.push([t.add_sx[0], t.add_sx[1]])
            : 110 === t.id
            ? (this.pulseLaserEnemySplit = !0)
            : 112 === t.id
            ? (this.pulseLaserBack = t.add_sx[0])
            : 114 === t.id && (this.pulseLaserSweepCount += 1);
    };
    e.prototype.toString = function () {
        return (
            t.prototype.toString.call(this) +
            "\n            脉冲激光攻击间隔:" +
            this.pulseLaserAtkInterval +
            "\n            脉冲激光最终持续时间:" +
            this.pulseLaserTime +
            "\n            脉冲激光宽度加成:" +
            this.pulseLaserWidthAdd +
            "\n            脉冲激光减速时间:" +
            this.pulseLaserSlowTime +
            "\n            脉冲激光减速加成:" +
            this.pulseLaserSlowAdd +
            "\n            脉冲激光扫荡次数:" +
            this.pulseLaserSweepCount +
            "\n            脉冲激光条数:" +
            this.pulseLaserCount +
            "\n            脉冲激光对怪物伤害加成:" +
            this.pulseLaserEnemyAtkAddParam +
            "\n            脉冲激光怪物无法分裂:" +
            this.pulseLaserEnemySplit +
            "\n            脉冲激光最终击退像素:" +
            this.pulseLaserBack +
            "\n        "
        );
